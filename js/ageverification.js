(function ($) {
  ...
  var STRINGS = {
    ko: {
      ...
      "captcha.disclaimer": "이 단계는 실제 봇 검사입니다.",
      "ad.alt": "점핑캣 아케이드 광고",
      "ad.closeAria": "광고 닫기",
    ...
    en: {
      ...
      "donate.disclaimer":
        "This window is part of an age-check Jumping Cat Arcade only.",
